 ...
 <?php 
  ...
  ?>
        <table class="st" style="margin-bottom: 200px; font-size: 13px; text-align: justify;">      
          ...
          <tr>
            <td><b><?php echo cargoe($cone, $r1['idEmpleado']) ?></b> del Ministerio Público, DECLARO BAJO JURAMENTO, haber efectuado la comisión de servicios a la ciudad de <b><?php echo $r1['destino'] ?></b></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>001-2007-EF/77.15, modificada por Resolución directoral N° 017-2007-EF/77.15, por el siguiente importe: <b><?php echo ($tdj=="" ? "" : n_2decimales($tdj)) ?></b></td>
          </tr>
        </table>
