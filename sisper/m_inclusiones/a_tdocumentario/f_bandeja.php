        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table table-bordered table-hover" style="font-size: 12px;">
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            <button type="button" class="btn bg-maroon" id="b_dercar" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Convirtiendo..." onclick="g_carori(<?php echo $idd.', '.$rd['cargo']; ?>);"><i class="fa fa-toggle-on"></i> Convertir a <?php echo $rd['cargo']==1 ? 'original' : 'cargo' ?></button>
                        </td>
                    </tr>
                </table>
            </div>
