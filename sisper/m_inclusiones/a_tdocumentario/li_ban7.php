...
?>
<div class="col-sm-7">
    <h5 class="text-muted text-blue" style="font-weight: 600;"><i class="fa fa-table text-yellow"></i> <b>DOCUMENTOS DERIVADOS PENDIENTES DE RECEPCIÓN</b></h5>
...
<div class="col-sm-12">
<?php
    $cb=mysqli_query($cone, "SELECT d.idDoc, d.numdoc, d.Numero, d.Ano, d.Siglas, d.FechaDoc, td.TipoDoc, ed.idtdestadodoc, ed.fecha, g.numero numguia, g.anio, ed.idtdestado, ed.idEmpleado, ed.idtdmesapartes FROM doc d INNER JOIN tipodoc td ON d.idTipoDoc=td.idTipoDoc INNER JOIN tdestadodoc ed ON d.idDoc=ed.idDoc LEFT JOIN tdguia g ON ed.idtdguia=g.idtdguia WHERE ed.asignador=$idem AND ed.estado=1 AND ed.idtdestado=3 ORDER BY ed.fecha DESC;");
...
?>
                <tr style="font-size: 12px;">
                    ...
                    <td><?php echo !is_null($rb['idEmpleado']) ? nomempleado($cone, $rb['idEmpleado']) : nommpartes($cone, $rb['idtdmesapartes']); ?></td>
