					...
					<tr>
						<td align="center" valign="top" style="padding-left:13px; padding-right:13px; background-color:#ffffff;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
									...
									<td>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #FF7101;">
											<tr>
												...
												<td align="center" style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:40px; color: #FF7101">¡Feliz cumpleaños!</td>
											</tr>
										</table>
										<br>
									</td>
								...
								<tr>
									<td align="center" style="font-size: 16px; color: #555555; font-family:Arial, Helvetica, sans-serif;"><br>Estimad@<br><br></td>
								</tr>
								<tr>
									<td align="center" style="font-size: 40px; color: #0091B6; font-weight: bold; font-family:Arial, Helvetica, sans-serif;">
										GERARDO SEVERINO<br>INTOR OSORIO<br>
									</td>
								</tr>
								...
								<tr>
									<td align="center" valign="middle">
										<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top: 1px solid #7DA400; padding: 10px; margin-top: 10px; border-bottom: 1px solid #7DA400; padding: 10px; margin-top: 10px;">
											<tr>
												<td align="center" style="font-family:Georgia, 'Times New Roman', Times, serif; color: #777777; font-size:15px;">
