        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab"><i class="fa fa-circle-o text-blue"></i> Registro</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <button type="button" class="btn bg-teal" onclick="f_eleccion('agrele',0,0);"><i class="fa fa-archive"></i> Elección</button>
                  </div>
                  <div class="col-sm-12" id="r_eleccion">
