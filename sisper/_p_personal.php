...
<div class="wrapper">
  ...
  <div class="content-wrapper" id="ConPage">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><i class="fa fa-users"></i> Personal</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
           <!-- Default box -->
            <div class="box">
              ...
              <div class="box-body">
                <div class="row">
                  <form action="buscarpersonal.php" method="post" id="fb_personal">
                  <div class="col-md-9 form-group">
                      <input type="text" class="form-control" id="i_bpersonal" name="i_bpersonal" placeholder="Nombre">
                  </div>
                  <div class="col-md-3">
