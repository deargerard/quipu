...
?>
          <table border=1>
              <tr>
                    <th colspan="10"><font face="arial" color="#007fff" size="3">ATENCIONES DE MESA DE AYUDA</font></th>
              </tr>
...
?>
                <tr>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">N°</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">FEC. REPORTE</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">USUARIO</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">CARGO</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">DEPENDENCIA</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">CATEGORIA</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">REPORTABLE</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">DESCRIPCIÓN</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">ESTADO</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">FEC. SOLUCIÓN</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">TIEMPO</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">SOLUCIÓN</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">MEDIO</font></td>
                  <td bgcolor= "#007fff"><font color="#ffffff" size="2">RESPONSABLE</font></td>
...
?>
                <tr>
                  ...
                  <td><font color="#000000"><?php echo $rper['Oficial']== 1 ? "SÍ" : "NO"; ?></font></td>
