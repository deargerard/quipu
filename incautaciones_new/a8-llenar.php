          ...
          <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
			<form class="form-horizontal form-label-left" action="a8_agregar.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
					...
					<center>Nº. DE REGISTRO / CÓDIGO ÚNICO DE CASO N° <input type="text" name="caso" maxlength="10" size="10" value="<?php echo $caso?>"></center>      
