...
?>
			...
			<section class="content invoice">
                    ...
                    <thead>
                      <tr>
						  <th><h1>MINISTERIO PUBLICO </h1><h2>FISCALIA DE LA NACIÓN</h2></th>
					...
					<tr>
						...
						<td>
						            <address>
                                        <strong>Fecha Ingreso: <?php echo $rs_lib["f_ingreso"];?></strong>
                                        <br>Fecha de Salida: <?php echo $rs_lib["f_salida"];?>
                                        <br>Resoluciones salida: <?php echo $rs_lib["resol_salida"];?>
										<?php
										if($rs_lib["existente"]=='P')
										{
											echo "<br>Estado del Caso: PROCESADO";
										}
										else
										{
											echo "<br>Estado del Caso: POR PROCESAR";
										}
										?>
                                        <br>Observ 1: <?php echo $rs_lib["obs1"];?>
										<br>Observ 2: <?php echo $rs_lib["obs2"];?>
                                    </address>
						</td>
						<td>
					...
					<tr><td colspan="3">
							<?php 
							$i=1;
							$sSQL1 = "SELECT * FROM docs where id=$codigo";
							$result1 = mysqli_query($link1,$sSQL1);
							while($row1 = mysqli_fetch_array($result1))
							{ 
								echo 'Documento '.$i.': <a href="fotos/'.$row1['nombre_doc'].'" target="_blank">'.$row1['nombre_doc'].'</a>';
								$i++;
							}?>
						</td></tr>
					</tbody>
