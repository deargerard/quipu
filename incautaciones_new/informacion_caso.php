...
while($row = mysqli_fetch_array($result)) {?>
					...
					$an=date('Y');
					?>
				    <form class="form-horizontal form-label-left" action="modificacion_caso.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="boletai" class="form-control" placeholder="Numero de Boleta de Ingreso" value="<?php echo $row["b_ingreso"];?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha de Ingreso</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" name="fechai" class="form-control" placeholder="Fecha de Internamiento" value="<?php echo $row["f_ingreso"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Ubicacion<span class="required">*</span></label></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" name="ubicacion" class="form-control" value="<?php echo $row["ubicacion"]; ?>">
                      </div>
                    </div>
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Numero de Caso" name="caso" value="<?php echo $row["caso"]; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea class="form-control" rows="3" placeholder='Descripcion breve del bien o elemento internado' name="descripcion"> <?php echo $row["descripcion"]; ?></textarea>
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Marca</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Marca del bien u objeto de tenerlo" name="marca" value="<?php echo $row["marca"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Serie</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Serie en caso de tenerlo" name="serie" value="<?php echo $row["serie"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Estado<span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Bueno/Regular/Malo" name="estado" value="<?php echo $row["estado"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Tipo</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Tipo" name="tipo" value="<?php echo $row["elem_bien"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Observacion 1</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea class="form-control" rows="3" placeholder="De existir alguna observacion ingresarlo aqui" name="obs1"> <?php echo $row["obs1"]; ?></textarea>
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Observacion 2</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea class="form-control" rows="3" placeholder='De existir alguna observacion adicioal ingresarlo aqui' name="obs2"> <?php echo $row["obs2"]; ?></textarea>
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Delito<span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Delito cometido" name="delito"  value="<?php echo $row["delito"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Fiscal<span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Nombre del fiscal" name="fiscal" value="<?php echo $row["fiscal"]; ?>">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Fiscalia<span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" placeholder="Fiscalia" name="fiscalia" value="<?php echo $row["fiscalia"]; ?>">
                      </div>
                    </div>
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Condicion<span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
						  <input type="text" class="form-control" placeholder="Fiscalia" name="condicion" value="<?php echo $row["condicion"]; ?>">
                      </div>
                    </div>
