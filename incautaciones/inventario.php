      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw" onclick="return confirmar()"></i> <span>Internamiento!</span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              <ul class="nav side-menu">
				...
				<li><a href="inventario.php"><i class="fa fa-table"></i>Salida || Eliminar</a></li>
...
while($row = mysqli_fetch_array($result)) { ?>
                      <tr>
						...
						<td><a href="salida.php?id=<?php echo $row["id"];?>"><font color="#7B0C0E">Dar salida</font></a></td>
						<td><a href="expediente_elim.php?id=<?php echo $row["id"];?>" onclick="return confirmar()"><button class="btn-danger"><i class="fa fa-trash-o"></i> Delete </button></a></td>
					  <?php
						}?>
						</tbody>
                  </table>
