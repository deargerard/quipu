...
<div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                  <br />
                  <form class="form-horizontal form-label-left" action="ingreso_ag.php" method="POST">
...
$bn=$bnueva[0]+1;?>
                    <div class="form-group">
                      ...
                      <input type="text" name="boletai" class="form-control" placeholder="Numero de Boleta de Ingreso" value="<?php echo $bn."-".$bnueva[1]; ?>">
                      </div>
                    </div>
					  <?php
					...
					<div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="form-control" name="ubicacion" required="required" >
                          <option>Escoja una opcion</option>
                          <option value="SEDE CENTRAL">SEDE CENTRAL</option>
                          <option value="TAHUANTINSUYO">TAHUANTINSUYO</option>
                        </select>
                      </div>
                    </div>
					...
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Fiscalia<span class="required">*</span></label></label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
