          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              <ul class="nav side-menu">
				...
				<li><a href="consulta_ingresos.php"><i class="fa fa-search"></i>Boletas Ingreso</a></li>
				<li><a href="consulta_ingresos.php"><i class="fa fa-search"></i>Boletas Salida</a></li>
              </ul>
            </div>
			...
			<section class="content invoice">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th><h2>BOLETA SALIDA</h2><h3><?php echo $boleta;?></h3></th>	
                      </tr>
                    </thead>
					<tbody>
                     <tr>
                        <td colspan="2"><h3>FECHA: <?php echo $fecha;?></h3></td>
					</tr>
					<tr>
					    <td colspan="2">
						            <address>
                                        <strong>Caso: <?php echo $rs_lib["caso"];?></strong>
										<br>Fecha de Ingreso: <?php echo $rs_lib["f_ingreso"];?>
                                        <br>Lugar de custodia: <?php echo $rs_lib["ubicaccion"];?>
										...
										<br>Resolucion: <?php echo $rs_lib["resol_salida"];?>
